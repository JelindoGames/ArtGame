...
public static class BezierUtils
{
    ...
    /// <summary>
    /// Creates the contour of a circle.
    /// (This is used in multiple places, which is why it's been lifted to here.)
    /// </summary>
    public static BezierContour CircleContour(Vector2 center, float radius)
    {
